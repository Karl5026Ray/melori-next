...
export const metadata: Metadata = {
  title: "Melori Radio",
  description:
    "Non-stop Melori Radio — every track on the platform in one shuffle, plus a personalized For You station.",
};
...
// is a thin shell; RadioClient is a view of the site-wide shared player.
