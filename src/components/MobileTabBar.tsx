            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  {/* Concert (coming soon) — teal, sits opposite the M/Go Live
                     actions. This will become the TikTok-style "battle mode"
                     head-to-head live concert feature. Disabled for now. */}
                  {!activeCat && (
                    <button
                      type="button"
                      aria-disabled="true"
